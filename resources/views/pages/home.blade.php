...
@section('content')
    <div class="px-[5%] py-16 md:py-24 lg:py-28 flex flex-col gap-20">
        ...
        <div>
            <x-sections.text-section>
                <x-typography.header text="Discover Our Impact: Key Statistics About Paderteg Connecting
                        Solutions"/>
                <x-typography.paragraph text="
                                    With over 500 dedicated employees, Paderteg Connecting Solutions has
        ...
        <div class="grid grid-cols-1 gap-x-20 gap-y-12 md:gap-y-16 lg:grid-cols-2 lg:items-center">
            ...
            <x-elements.image class="w-full object-cover"
                              src="{{ asset('assets/pages/home/images/home-get-in-touch-image.png') }}"/>
        </div>
        ...
        >
            ...
            <div class="grid grid-cols-1 gap-y-12 md:grid-cols-2 md:gap-x-8 lg:gap-16 mb-20">
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Milonean Ioan Marius.png') }}"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Anca Ganfalean.png') }}"
                    name="Anca Ganfalean"
                    role="Finance & HR"
                    description="Leading our vision with a commitment to innovation and excellence."
                    phone="0745345390"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Dura Cristian.png') }}"
                    name="Dura Cristian"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Stanciu Dana.png') }}"
                    name="Stanciu Dana"
                    role="Quality & EHS"
                    description="Leading our vision with a commitment to innovation and excellence."
                    phone="0745345390"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Necsuleu Cosmin.png') }}"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Barac Ramona.png') }}"
                    name="Barac Ramona"
                    role="Logistics"
                    description="Leading our vision with a commitment to innovation and excellence."
                    phone="0745345390"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Oancea Gheorghe.png') }}"
                ...
                />
                <x-cards.person-card
                    avatar-src="{{ asset('assets/pages/about/Papara Carmen.png') }}"
                    name="Papara Carmen"
                    role="Purchasing"
                    description="Leading our vision with a commitment to innovation and excellence."
                    phone="0745345390"
